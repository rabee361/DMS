...
urlpatterns = [
    ...
    path('forms/fields/add/<int:id>', views.CreateFormFieldsView.as_view(), name='add_form_fields'),
    path('forms/<int:pk>/add', views.CreateRecordView.as_view(), name='add_record'),
    path('forms/<int:pk>/update', views.UpdateFormView.as_view(), name='update_form'),
